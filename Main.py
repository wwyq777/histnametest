...
UPDATE_CHANNEL = 'https://www.instagram.com/guaxwx64' # Replace with your update channel link
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        ...
        types.InlineKeyboardButton('📞 Falar com dono', url=f'https://www.instagram.com/guaxwx64{YOUR_USERNAME.replace("@tearsofmoney7", "")}')
    ]
...
def _logic_contact_owner(message):
    markup = types.InlineKeyboardMarkup()
    markup.add(types.InlineKeyboardButton('📞 Contato dono', url=f'https://www.instagram.com/guaxwx64{YOUR_USERNAME.replace("@tearsofmoney7", "")}'))
